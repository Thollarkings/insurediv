...
import { Lock, User, Send, ShieldCheck, LogOut } from 'lucide-react';
...
const Admin = () => {
    ...
    const handleLogin = (e) => {
        ...
        if (email.includes('@') && password.length >= 4) {
            ...
            alert('Please use a valid staff email and a password of at least 4 characters.');
        }
    };
    ...
    const handleSend = async (e) => {
        ...
        await sendMessage({ body: newMessage, author: currentUser });
        setNewMessage('');
    };
            ...
            <div className="min-h-screen flex items-center justify-center bg-[#002147] px-4">
                <div className="max-w-md w-full bg-white/10 backdrop-blur-lg p-10 rounded-3xl border border-white/20 shadow-2xl">
                    ...
                    <form className="space-y-6" onSubmit={handleLogin}>
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="name@divineinsure.com"
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <button className="w-full bg-[#D4AF37] text-[#002147] py-4 rounded-xl font-bold text-lg hover:bg-white transition-all shadow-xl">
                            Authorize Entry
                        </button>
                    </form>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-end mb-12">
                    <div>
                        ...
                        <p className="text-gray-500">Signed in as <strong>{currentUser}</strong></p>
                    </div>
                    <button
                ...
                <div className="bg-white rounded-3xl border border-gray-200 flex flex-col h-[70vh] overflow-hidden shadow-2xl">
                    ...
                    <div className="flex-1 p-6 overflow-y-auto space-y-4 bg-gray-50">
                        ...
                        {[...messages].reverse().map((msg) => (
                            <div
                                key={msg._id}
                                className={`flex flex-col ${msg.author === currentUser ? 'items-end ml-auto' : 'items-start'} max-w-[75%]`}
                            >
                                <span className="text-xs text-gray-500 font-bold mb-1 px-1">{msg.author}</span>
                                <div className={`p-4 rounded-2xl text-sm shadow-sm ${msg.author === currentUser ? 'bg-[#D4AF37] text-[#002147] rounded-tr-none font-medium' : 'bg-[#002147] text-white rounded-tl-none'}`}>
                                    {msg.body}
                                </div>
